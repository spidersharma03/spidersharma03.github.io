	...
	vertexShader: [
		...
		"void main() {",
			...
			"vec4 worldPosition = modelMatrix * vec4( position, 1.0 );",
                                                "worldPosVar = worldPosition.xyz;",
			"mirrorCoord = textureMatrix * worldPosition;",
                                                "worldNormal = (modelMatrix * vec4(normal,1.0)).xyz;",
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"color = vec4(blendOverlay(mirrorColor.r, color.r), blendOverlay(mirrorColor.g, color.g), blendOverlay(mirrorColor.b, color.b), 1.0);",
                                                "float dotProd = (dot(normalize(cameraPosition-worldPosVar), normalize(worldNormal)));",
                                                "float fresenel = pow(1.0-dotProd,4.0);",
			"color = vec4( vec3(0.1) + color.rgb * (0.2 + fresenel), 1.0);",
